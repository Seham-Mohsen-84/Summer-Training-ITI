...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    $result= $DB->Update(
        "users",
        "fname='$fname', lname='$lname', address='$address', country='$country', gender='$gender', username='$username', password='$password', department='$department', photo='$photoName'",
        "id = '$id'"
    );
